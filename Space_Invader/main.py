...
# Classe pour gerer les projectiles
class Laser:
...
# Instance de Ship pour le vaisseau du joueur
class Player(Ship):
    def __init__(self, x, y, health=100):
        ...
        # Prendre les dimensions du png pour gerer les collisions
...
# Instance de Ship pour le vaisseau enemy
class Enemy(Ship):
    COLOR_MAP = {
...
def main():
    ...
    def redraw_window():
        ...
        # Affiche l image de fond d ecran
        WIN.blit(BG,(0,0))
        ...
        # Afficher le spaceship
        player.draw(WIN)

        # Affichage du GAME OVER
        if lost:
            lost_label = lost_font.render("Tu AS PERDU !!", 1, (255,0,0))
...
def main_menu():
    ...
    while run :
        WIN.blit(BG, (0, 0))
        title_label = title_font.render("Appuyez sur un button pour commencer", 1, (255,255,255))
